...
class CRASH_PT_utilities(Panel):
    bl_label = "Utilities"
...
class CRASH_PT_utilities_timeline(Panel):
    bl_label = "Timeline"
    bl_parent_id = "CRASH_PT_utilities"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "CrashXform"
    ...
    def draw(self, context):
        ...
        layout.operator(Timeline_Set_End_Frame.bl_idname, text="Set End Frame")

class CRASH_PT_utilities_shape_keys(Panel):
    bl_label = "Objects"
    bl_parent_id = "CRASH_PT_utilities"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    ...
    def draw(self, context):
        ...
        layout.operator(Convert_Shape_Keys.bl_idname, text="Convert to Shape Keys")

class CRASH_PT_utilities_shader(Panel):
    bl_label = "Shader"
    bl_parent_id = "CRASH_PT_utilities"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    ...
    def draw(self, context):
        ...
        layout.operator(Create_PSX_Shader_Nodes.bl_idname, text="Create Shader Nodes")

class CRASH_PT_utilities_materials(Panel):
    bl_label = "Materials"
    bl_parent_id = "CRASH_PT_utilities"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    ...
    def draw(self, context):
        ...
        layout.operator(Materials_Remove_Unused_Slots.bl_idname, text="Remove Unused Slots")
        layout.operator(Materials_Unify.bl_idname, text="Unify Slots")

class CRASH_PT_optimization(Panel):
...
class CRASH_PT_opt_mesh(Panel):
    bl_label = "Mesh"
    bl_parent_id = "CRASH_PT_optimization"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "CrashXform"
...
class CRASH_PT_opt_color(Panel):
    bl_label = "Colors"
    bl_parent_id = "CRASH_PT_optimization"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
...
class CRASH_PT_opt_execute(Panel):
    ...
    def draw(self, context):
        ...
        layout.operator(Crash_Optimization.bl_idname, text="Optimize")

class CRASH_PT_export(Panel):
    bl_label = "Export"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "CrashXform"
    ...
    def draw(self, context):
        ...
        layout.operator(Crash_Export.bl_idname, text="Export")

class CRASH_PT_info(Panel):
    bl_label = "Info"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "CrashXform"
...
class Timeline_Set_End_Frame(Operator):
...
class Convert_Shape_Keys(Operator):
...
class Create_PSX_Shader_Nodes(Operator):
...
class Materials_Remove_Unused_Slots(Operator):
...
class Materials_Unify(Operator):
...
class Crash_Optimization(Operator):
...
classes = [
    ...
    ExportSettings,
    CRASH_PT_utilities,
    CRASH_PT_utilities_timeline,
    CRASH_PT_utilities_shape_keys,
    CRASH_PT_utilities_shader,
    CRASH_PT_utilities_materials,
    CRASH_PT_optimization,
    CRASH_PT_opt_mesh,
    CRASH_PT_opt_color,
    CRASH_PT_opt_execute,
    CRASH_PT_export,
    CRASH_PT_info,
    Timeline_Set_End_Frame,
    Convert_Shape_Keys,
    Create_PSX_Shader_Nodes,
    Materials_Remove_Unused_Slots,
    Materials_Unify,
    Crash_Optimization,
    Crash_Export
]
